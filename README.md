...
_See code: [src/commands/download.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/download.js)_
...
_See code: [src/commands/forms.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/forms.js)_
...
_See code: [src/commands/optimize/css.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/optimize/css.js)_
...
_See code: [src/commands/optimize/images.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/optimize/images.js)_
...
_See code: [src/commands/optimize/js.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/optimize/js.js)_
...
_See code: [src/commands/urls.js](https://github.com/mdyd-dev/posify/blob/v0.1.6/src/commands/urls.js)_
<!-- commandsstop -->
